  ...
  <table class="table table-striped table-bordered table-hover text-center">
    ...
    <tbody>
      <?php
        ...
        $select_car = "SELECT * FROM `categories`";
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          echo "<tr>
            ...
            <td>
              <a href='index.php?edit_category=$category_id' class='text-dark edit-icon'>
                <i class='fas fa-pen-square' style='font-size: 24px;'></i>
              </a>
            </td>
            <td>
              <a href='index.php?Delete_category=$category_id' class='text-danger delete-icon' data-toggle='modal' data-target='#exampleModal'>
